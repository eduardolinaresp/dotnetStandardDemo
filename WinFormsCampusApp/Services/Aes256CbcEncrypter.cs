...
namespace WinFormsCampusApp
{
    public class Aes256CbcEncrypter
    {
        ...
        public static string Decryptphp(string cipherData, string keyString, string ivString = "1234567890123456")
        {
            ...
            try
            {
                using (var rijndaelManaged =
                       new RijndaelManaged { Key = key, BlockSize = 256, IV = iv, Mode = CipherMode.CBC })
