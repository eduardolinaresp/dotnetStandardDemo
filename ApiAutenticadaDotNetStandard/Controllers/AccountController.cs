...
using ApiAutenticadaDotNetStandard.Models;
using ApiAutenticadaDotNetStandard.Providers;
using ApiAutenticadaDotNetStandard.Results;

namespace ApiAutenticadaDotNetStandard.Controllers
{
    [Authorize]
